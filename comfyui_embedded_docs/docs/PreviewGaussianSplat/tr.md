...
| `width` | Önizleme çıktısının piksel cinsinden genişliği (varsayılan: 1024). | INT | Evet | 1 ila 4096 |
| `height` | Önizleme çıktısının piksel cinsinden yüksekliği (varsayılan: 1024). | INT | Evet | 1 ila 4096 |
...
| `width` | Önizleme çıktısının genişliği. | INT |
| `height` | Önizleme çıktısının yüksekliği. | INT |
