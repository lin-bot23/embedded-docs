...
| --- | --- | --- | --- | --- |
| `pozitif` | Referans görüntülerin ekleneceği pozitif conditioning. | CONDITIONING | Evet | - |
| `negatif` | Referans görüntülerin ekleneceği negatif conditioning. | CONDITIONING | Evet | - |
| `görseller` | Referans görüntüler sayısal soket sırasına göre kullanılır. Görüntüler sağlandığında, hem pozitif hem de negatif conditioning'e eklenir. | IMAGE | Hayır | 0 ila 100 görüntü (`image_1` - `image_100`) |
...
| --- | --- | --- |
| `pozitif` | Referans görüntülerin eklendiği pozitif conditioning. | CONDITIONING |
| `negatif` | Referans görüntülerin eklendiği negatif conditioning. | CONDITIONING |
