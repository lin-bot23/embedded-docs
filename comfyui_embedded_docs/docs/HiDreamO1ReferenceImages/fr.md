...
| --- | --- | --- |
| `positive` | Le conditionnement `positive` avec les images de référence attachées. | CONDITIONING |
| `negative` | Le conditionnement `negative` avec les images de référence attachées. | CONDITIONING |
