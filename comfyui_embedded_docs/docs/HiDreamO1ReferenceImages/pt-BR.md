...
| --- | --- | --- | --- | --- |
| `positivo` | O condicionamento positivo ao qual anexar imagens de referência. | CONDITIONING | Sim | - |
| `negativo` | O condicionamento negativo ao qual anexar imagens de referência. | CONDITIONING | Sim | - |
| `imagens` | As imagens de referência são usadas na ordem numérica dos soquetes. Quando imagens são fornecidas, elas são anexadas tanto ao condicionamento positivo quanto ao negativo. | IMAGE | Não | 0 a 100 imagens (`image_1` a `image_100`) |
