...
| `yüz_sınırı` | Hedef yüz sayısı, 48-20000. -1, Tripo'nun uyarlamalı seçim yapmasını sağlar. (varsayılan: -1) | INT | Hayır | -1 to 20000 |
| `model_tohumu` | Sonuçların yeniden üretilebilmesi için geometri oluşturmada kullanılan tohum. (varsayılan: 42) | INT | Hayır | 0 to 2147483647 |
...
| `texture_seed` | Dokulu sonuçların yeniden üretilebilmesi için doku oluşturmada kullanılan tohum. (varsayılan: 42) | INT | Evet | 0 to 2147483647 |
