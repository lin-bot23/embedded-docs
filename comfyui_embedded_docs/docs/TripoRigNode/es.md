...
|-----------|-------------|-----------|----------|-------|
| `original_model_task_id` | El ID de tarea del modelo 3D original al que se aplicará el rig. Normalmente es el ID generado por un nodo anterior de generación de modelos de Tripo. | MODEL_TASK_ID | Sí | - |
...
|-------------|-------------|-----------|
| `model_file` | El archivo de modelo 3D con rig generado. Se conserva solo por compatibilidad con versiones anteriores. | STRING |
| `rig task_id` | El ID de tarea para el seguimiento del proceso de generación de rig. | RIG_TASK_ID |
