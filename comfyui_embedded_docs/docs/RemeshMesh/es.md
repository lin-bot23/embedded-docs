...
| `resolution` | Resolución de la rejilla de vóxeles (densidad de salida). 256 ~ 100k caras, 512 ~ 1M. Para un número exacto de caras, aplique Decimate Mesh a continuación. (predeterminado: 512) | INT | Sí | 32 - 2048 |
