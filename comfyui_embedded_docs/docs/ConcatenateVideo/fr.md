...
| `codec` | Codec utilisé pour encoder les tenseurs vidéo. Auto utilise H.264 ; les vidéos déjà encodées restent inchangées. Par défaut : « auto » | COMBO | Oui | `"auto"`<br>Les autres options sont définies par les types de codecs vidéo disponibles. |
