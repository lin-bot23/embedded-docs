...
| --- | --- | --- | --- | --- |
| `name` | El nombre del archivo del parche de modelo que se cargará desde el directorio `model_patches`. Seleccione uno de los archivos de parche disponibles en la lista. | COMBO | Sí | Lista generada dinámicamente de todos los archivos de parche de modelo encontrados en la carpeta `model_patches` |
