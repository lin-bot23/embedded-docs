...
| --- | --- | --- | --- | --- |
| `source` | Acepta cualquier tipo de dato de entrada para mostrarlo en la vista previa. Si no se proporciona ningún valor, la vista previa muestra 'None'. | ANY | Sí | Cualquier tipo de dato |
