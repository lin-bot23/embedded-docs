...
GetImageSize, bir girdi görüntüsünü okur ve genişliğini, yüksekliğini ve parti boyutunu döndürür. Düğüm ayrıca bu ölçülen değerleri doğrudan düğüm arayüzünde görüntüler.

## Girdiler

| Parametre | Açıklama | Veri Türü | Gerekli | Aralık |
|-----------|-----------|-----------|---------|--------|
| `image` | Genişlik, yükseklik ve parti boyutunun çıkarıldığı girdi görüntüsü | IMAGE | Evet | - |
