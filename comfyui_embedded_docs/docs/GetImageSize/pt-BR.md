...
O nó GetImageSize lê uma imagem de entrada e retorna sua largura, altura e tamanho do lote. O nó também exibe esses valores medidos diretamente na interface do nó.
